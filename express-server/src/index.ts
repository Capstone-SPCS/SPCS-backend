...
// on a 2-minute basis to add CDM batches periodically.
async function setupRepeatableJobs() {
  ...
  console.log('[CDM_SERVICE] Set up repeatable CDM processing job (every 2 minutes)');
}
...
mainServer.listen(API_PORT, async () => {
  ...
  // Set up repeatable job to add new CDM batches every 2 minutes
